/*	$ssdlinux: gen_db_server.c,v 1.1 2004/12/27 03:02:29 yamagata Exp $	*/
...
__db_env_get_cachesize_4003_svc(msg, req)
...
__db_env_cachesize_4003_svc(msg, req)
...
__env_close_reply *
__db_env_close_4003_svc(msg, req)
	__env_close_msg *msg;
	struct svc_req *req;
{
...
__env_create_reply *
__db_env_create_4003_svc(msg, req)
...
__db_env_dbremove_4003_svc(msg, req)
...
__db_env_dbrename_4003_svc(msg, req)
...
__db_env_get_encrypt_flags_4003_svc(msg, req)
...
__env_encrypt_reply *
__db_env_encrypt_4003_svc(msg, req)
...
__db_env_get_flags_4003_svc(msg, req)
...
__env_flags_reply *
__db_env_flags_4003_svc(msg, req)
	__env_flags_msg *msg;
	struct svc_req *req;
{
...
__db_env_get_home_4003_svc(msg, req)
...
__db_env_get_open_flags_4003_svc(msg, req)
...
__env_open_reply *
__db_env_open_4003_svc(msg, req)
	__env_open_msg *msg;
	struct svc_req *req;
{
...
__env_remove_reply *
__db_env_remove_4003_svc(msg, req)
...
__txn_abort_reply *
__db_txn_abort_4003_svc(msg, req)
	__txn_abort_msg *msg;
	struct svc_req *req;
{
...
__txn_begin_reply *
__db_txn_begin_4003_svc(msg, req)
	__txn_begin_msg *msg;
	struct svc_req *req;
{
...
__txn_commit_reply *
__db_txn_commit_4003_svc(msg, req)
...
__txn_discard_reply *
__db_txn_discard_4003_svc(msg, req)
...
__txn_prepare_reply *
__db_txn_prepare_4003_svc(msg, req)
...
__txn_recover_reply *
__db_txn_recover_4003_svc(msg, req)
...
__db_db_associate_4003_svc(msg, req)
...
__db_db_bt_maxkey_4003_svc(msg, req)
...
__db_db_get_bt_minkey_4003_svc(msg, req)
...
__db_db_bt_minkey_4003_svc(msg, req)
...
__db_close_reply *
__db_db_close_4003_svc(msg, req)
	__db_close_msg *msg;
	struct svc_req *req;
{
...
__db_create_reply *
__db_db_create_4003_svc(msg, req)
	__db_create_msg *msg;
	struct svc_req *req;
{
...
__db_db_get_encrypt_flags_4003_svc(msg, req)
...
__db_encrypt_reply *
__db_db_encrypt_4003_svc(msg, req)
...
__db_db_get_extentsize_4003_svc(msg, req)
...
__db_db_extentsize_4003_svc(msg, req)
...
__db_db_get_flags_4003_svc(msg, req)
...
__db_flags_reply *
__db_db_flags_4003_svc(msg, req)
	__db_flags_msg *msg;
	struct svc_req *req;
{
...
__db_get_name_reply *
__db_db_get_name_4003_svc(msg, req)
...
__db_db_get_open_flags_4003_svc(msg, req)
...
__db_db_get_h_ffactor_4003_svc(msg, req)
...
__db_db_h_ffactor_4003_svc(msg, req)
...
__db_db_get_h_nelem_4003_svc(msg, req)
...
__db_h_nelem_reply *
__db_db_h_nelem_4003_svc(msg, req)
...
__db_db_key_range_4003_svc(msg, req)
...
__db_db_get_lorder_4003_svc(msg, req)
...
__db_lorder_reply *
__db_db_lorder_4003_svc(msg, req)
	__db_lorder_msg *msg;
	struct svc_req *req;
{
...
__db_db_get_pagesize_4003_svc(msg, req)
...
__db_pagesize_reply *
__db_db_pagesize_4003_svc(msg, req)
...
__db_db_get_re_delim_4003_svc(msg, req)
...
__db_re_delim_reply *
__db_db_re_delim_4003_svc(msg, req)
...
__db_db_get_re_len_4003_svc(msg, req)
...
__db_re_len_reply *
__db_db_re_len_4003_svc(msg, req)
	__db_re_len_msg *msg;
	struct svc_req *req;
{
...
__db_re_pad_reply *
__db_db_re_pad_4003_svc(msg, req)
	__db_re_pad_msg *msg;
	struct svc_req *req;
{
...
__db_db_get_re_pad_4003_svc(msg, req)
...
__db_remove_reply *
__db_db_remove_4003_svc(msg, req)
	__db_remove_msg *msg;
	struct svc_req *req;
{
...
__db_rename_reply *
__db_db_rename_4003_svc(msg, req)
	__db_rename_msg *msg;
	struct svc_req *req;
{
...
__db_truncate_reply *
__db_db_truncate_4003_svc(msg, req)
...
__db_cursor_reply *
__db_db_cursor_4003_svc(msg, req)
	__db_cursor_msg *msg;
	struct svc_req *req;
{
...
__dbc_close_reply *
__db_dbc_close_4003_svc(msg, req)
	__dbc_close_msg *msg;
	struct svc_req *req;
{
...
__dbc_count_reply *
__db_dbc_count_4003_svc(msg, req)
	__dbc_count_msg *msg;
	struct svc_req *req;
{
...
__dbc_pget_reply *
__db_dbc_pget_4003_svc(msg, req)
	__dbc_pget_msg *msg;
	struct svc_req *req;
{
