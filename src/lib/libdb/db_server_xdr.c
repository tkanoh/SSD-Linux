/*	$ssdlinux: db_server_xdr.c,v 1.3 2004/12/27 03:02:29 yamagata Exp $	*/
/*
...
bool_t
xdr___db_get_extentsize_msg (XDR *xdrs, __db_get_extentsize_msg *objp)
{
	register int32_t *buf;
...
bool_t
xdr___db_get_extentsize_reply (XDR *xdrs, __db_get_extentsize_reply *objp)
{
	register int32_t *buf;
...
bool_t
xdr___db_get_name_msg (XDR *xdrs, __db_get_name_msg *objp)
{
	register int32_t *buf;
...
bool_t
xdr___db_get_name_reply (XDR *xdrs, __db_get_name_reply *objp)
{
	register int32_t *buf;
