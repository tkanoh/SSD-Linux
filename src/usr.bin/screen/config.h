/*	$ssdlinux: config.h,v 1.7 2004/02/03 06:47:21 yamagata Exp $	*/
/*
 *	Add -lmisc after -lshadow in configure, then execute configure.
 */
 ...
 */
#ifndef ETCSCREENRC
# define ETCSCREENRC "/usr/etc/screenrc"
#endif
